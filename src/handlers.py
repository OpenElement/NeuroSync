...
class RequestHandlers:
    def __init__(self, config, bots, bot_tasks, bot_task_map, synapse_client, message_queue):
        self.config = config
        self.bots = bots
    ...
    # Handles sending messages via a bot.
    ...
    # Handles receiving messages from a bot.
    ...
    # Handles activating a bot by username
    ...
    # Handles deactivating a bot by username
