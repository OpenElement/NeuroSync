...
class MatrixWebhookBot:
    ...
    async def handle_receive(self, request): # Now only handles GET requests
    ...
    async def handle_create_bot(self, request):
        try:
            ...
            # Placeholder for actual bot creation logic
            print(f"Bot creation requested for user: {username}") 

            return web.json_response({"status": "success", "username": username})
        except Exception as e:
            print(f"Error in handle_create_bot: {e}")
